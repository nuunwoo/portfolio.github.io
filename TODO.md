...
- [ ] 잠금화면 레이아웃 시안 확정
- [ ] 시계/날짜 컴포넌트 분리
- [ ] 사용자 아바타 또는 프로필 영역 설계
- [ ] 엔터, 클릭, 슬라이드 등 잠금해제 인터랙션 결정
- [ ] 모바일/데스크톱 반응형 처리

## Desktop

- [ ] 바탕화면 wallpaper 선택 방식 정리
- [ ] 메뉴바 UI 연결
- [ ] dock 또는 앱 아이콘 영역 설계
...
- [ ] 부팅 사운드 또는 모션 옵션 고려
- [ ] 다크/라이트 또는 시간대 기반 배경 변화
- [ ] 간단한 fake terminal / about window 추가
- [ ] 프로젝트 창 드래그/포커스 인터랙션 추가

## Git Decision

- 공개용 체크리스트라면 Git에 올려도 좋음
- 개인 메모, 링크 초안, 비공개 아이디어까지 적을 거라면 로컬 전용 문서로 분리하는 편이 좋음
- 현재 파일은 공개 가능한 작업 목록 기준으로 작성했기 때문에 커밋해도 무방함
