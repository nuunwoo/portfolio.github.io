...
import type {DesktopWorkspaceState} from '../lib/useDesktopViewState';
...
const DesktopView = ({workspaceState, isScaledDown = false, disableScaleTransition = false, hideAnimatedItems = false}: DesktopViewProps) => {
  const {
    breadcrumbItems,
  ...
  return (
    <div
      className={styles.scaleRoot}
      style={
        {
          '--desktop-layer-zoom': isScaledDown ? '0.94' : '1',
        } as CSSProperties
      }>
